...
function proxy_url_field_html() {
  ...
  <p>Enter the remote URL to proxy images from</p>
  <?php
}
function local_url_field_html() {
  ...
  <p>Enter the local URL to save images to</p>
  <?php
}
